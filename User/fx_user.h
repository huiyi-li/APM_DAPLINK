...
#define FX_MAX_LONG_NAME_LEN            24
#define FX_MAX_LAST_NAME_LEN            24   /* Must be as large or larger than FX_MAX_LONG_NAME_LEN */
...
#define FX_MAX_SECTOR_CACHE             8   /* Minimum value is 2, all other values must be power of 2.  */
