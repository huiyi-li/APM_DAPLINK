#ifndef LCD_FONT_8X16_H
#define LCD_FONT_8X16_H

#include <stdint.h>

/* 8x16 ASCII font, extracted from the reference LCD driver. */
/* index = char_code - 0x20; each glyph is 16 bytes, MSB left. */
