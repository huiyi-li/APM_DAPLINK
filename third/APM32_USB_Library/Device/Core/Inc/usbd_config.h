...
/*!< [31:16] APM32 USB Device Library main version V1.0.0*/
#define __APM32_USB_DEVICE_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __APM32_USB_DEVICE_VERSION_SUB1   (0x00) /*!< [23:16] sub1 version */
#define __APM32_USB_DEVICE_VERSION_SUB2   (0x00) /*!< [15:8]  sub2 version */
...
typedef struct
{
    ...
    USBD_DescCallback_T     interfaceDescHandler;
